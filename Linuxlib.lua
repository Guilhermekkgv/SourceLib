...
function Library:Create(table)
    ...
    local subtitleText = table.Subtitle or ""
    ...
    title.Position = UDim2.fromScale(0.015, 0.015)
    title.Size = UDim2.fromOffset(120, 25)
    title.Parent = main
    ...
    subtitle.Position = UDim2.fromScale(0.225, 0.015)
    subtitle.Size = UDim2.fromOffset(60, 25)
    subtitle.Parent = main

    local titleLine = Instance.new("Frame")
    titleLine.Name = "titleLine"
    titleLine.BackgroundColor3 = Color3.fromRGB(128, 0, 128)
    titleLine.Position = UDim2.fromScale(0.015, 0.1)
    titleLine.Size = UDim2.fromOffset(484, 2)
    ...
    closeButton.Position = UDim2.fromScale(0.95, 0.015)
    closeButton.Image = "rbxassetid://10747384394"
    closeButton.ImageColor3 = Color3.fromRGB(128, 0, 128)
    ...
    tabContainer.Position = UDim2.fromScale(0.03, 0.15)
    tabContainer.Size = UDim2.fromOffset(110, 190)
    ...
    playerInfoFrame.Position = UDim2.fromScale(0.03, 0.86)
    playerInfoFrame.Size = UDim2.fromOffset(470, 40)

    local playerIcon = Instance.new("ImageLabel")
    playerIcon.Name = "playerIcon"
    playerIcon.BackgroundTransparency = 1
    playerIcon.Position = UDim2.fromScale(0.01, 0)
    playerIcon.Size = UDim2.fromOffset(30, 30)
    playerIcon.Image = Players:GetUserThumbnailAsync(LocalPlayer.UserId, Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size48x48)
    playerIcon.Parent = playerInfoFrame

    local uICornerPlayerIcon = Instance.new("UICorner")
    uICornerPlayerIcon.CornerRadius = UDim.new(1, 0)
    uICornerPlayerIcon.Parent = playerIcon
    ...
    playerName.Position = UDim2.fromScale(0.1, 0)
    playerName.Size = UDim2.fromOffset(150, 30)
    playerName.TextXAlignment = Enum.TextXAlignment.Left
    playerName.Parent = playerInfoFrame

    local executionTime = Instance.new("TextLabel")
    executionTime.Name = "executionTime"
    executionTime.Font = Enum.Font.Gotham
    executionTime.Text = formatTime(os.difftime(os.time(), startTime))
    executionTime.TextColor3 = Color3.fromRGB(200, 200, 200)
    executionTime.TextSize = 12
    executionTime.BackgroundTransparency = 1
    executionTime.Position = UDim2.fromScale(0.75, 0.6)
    executionTime.Size = UDim2.fromOffset(100, 20)
    executionTime.TextXAlignment = Enum.TextXAlignment.Right
    executionTime.Parent = playerInfoFrame
    ...
    function tabHandler:Tab(name, iconId)
        ...
        main1.Text = name
        main1.TextColor3 = Color3.fromRGB(180, 180, 180)
        main1.TextSize = 14
        ...
        icon.ImageColor3 = Color3.fromRGB(128, 0, 128)
        icon.Parent = main1
        ...
        container.Position = UDim2.fromScale(0.26, 0.15)
        ...
        holder.Size = UDim2.fromOffset(350, 230)
        ...
        main1.MouseEnter:Connect(function()
            if not container.Visible then
                main1.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
                main1.BackgroundTransparency = 0.7
                icon.ImageColor3 = Color3.fromRGB(147, 112, 219)
        ...
        main1.MouseButton1Click:Connect(function()
            ...
            for _,v in pairs(tabContainer:GetChildren()) do
                if v:IsA("TextButton") then
                    ...
                    v:FindFirstChild("icon").ImageColor3 = Color3.fromRGB(128, 0, 128)
                    v:FindFirstChild("textLabel").TextTransparency = 0.5
                    v:FindFirstChild("textLabel").TextColor3 = Color3.fromRGB(180, 180, 180)
                end
            end
            container.Visible = true
            main1.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
            main1.BackgroundTransparency = 0.5
        ...
        function ElementHandler:Slider(text, default, min, max, callback)
            ...
            textLabel1.Size = UDim2.fromOffset(250, 30)
            textLabel1.Parent = slider

            local frame = Instance.new("Frame")
            frame.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
            frame.BackgroundTransparency = 0
            frame.Position = UDim2.fromScale(0.76, 0.35)
            frame.Size = UDim2.fromOffset(80, 6)
            frame.Parent = slider
            ...
            frame1.Size = UDim2.fromOffset(((default - min) / (max - min)) * 80, 6)
            frame1.Parent = frame
            ...
            textLabel2.Position = UDim2.fromScale(0.65, 0)
            ...
            UserInputService.InputChanged:Connect(function(input)
                if dragging and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
                    ...
                    frame1.Size = UDim2.fromOffset(percentage * 80, 6)
                    callback(value)
                end
            end)
        ...
        function ElementHandler:Toggle(text, callback)
            ...
            frame3.Position = UDim2.fromScale(0.92, 0.25)
            ...
            uIStroke1.Color = Color3.fromRGB(60, 60, 60)
            ...
            toggle1.MouseButton1Click:Connect(function()
                ...
                callback(tog)
                if tog then
                    frame3.BackgroundColor3 = Color3.fromRGB(128, 0, 128)
        ...
        function ElementHandler:Textbox(text, callback)
            ...
            textLabel6.TextColor3 = Color3.fromRGB(180, 180, 180)
        ...
        function ElementHandler:Dropdown(text, options, default, callback)
            ...
            arrowIcon.ImageColor3 = Color3.fromRGB(128, 0, 128)
            ...
            dropdownButton.MouseEnter:Connect(function()
                ...
                arrowIcon.ImageColor3 = Color3.fromRGB(147, 112, 219)
            end)
    ...
    tabContainer.ChildAdded:Connect(function()
        local firstContainer = main:FindFirstChild("container")
        if firstContainer then
            ...
            if firstButton then
                ...
                firstButton.BackgroundTransparency = 0.5
                firstButton:FindFirstChild("icon").ImageColor3 = Color3.fromRGB(255, 255, 255)
                firstButton:FindFirstChild("textLabel").TextTransparency = 0
                firstButton:FindFirstChild("textLabel").TextColor3 = Color3.fromRGB(255, 255, 255)
            end
        end
    end)
